(function() {
  ...
  const translations = window.translations = {
    en: {
      ...
      'catalog.title': 'Catalog', 'catalog.lead': 'Browse our product catalog by brand. Each section highlights available products and key product information for quick comparison.', 'catalog.back': 'Back to Catalog', 'catalog.brand.empty': 'Create a brand first to organize your catalog.', 'catalog.products.empty': 'No products in this section yet.', 'catalog.loadMoreBrands': 'Load more brands', 'catalog.loadingBrands': 'Loading…', 'catalog.loadingProducts': 'Loading products…', 'catalog.previous': 'Previous', 'catalog.next': 'Next', 'catalog.pageIndicator': 'Page', 'catalog.uncategorized': 'Uncategorized', 'catalog.error': "We couldn't load the catalog right now.", 'catalog.retry': 'Retry', 'catalog.brand.imageAlt': 'Brand logo', 'catalog.brand.productCatalog': 'Product Catalog', 'catalog.spec.origin': 'Origin', 'catalog.spec.netWeight': 'Net weight', 'catalog.spec.expiration': 'Expiration', 'catalog.spec.packing': 'Packing', 'product.spec.origin': 'Origin', 'product.spec.netWeight': 'Net weight', 'product.spec.expiration': 'Expiration', 'product.spec.packing': 'Packing',
    ...
    enTitle: {
      ...
      'catalog.title': 'カタログ', 'catalog.lead': 'ブランドごとに製品カタログをご覧いただけます。各製品の基本情報を比較しやすいよう整理しています。', 'catalog.back': 'カタログに戻る', 'catalog.brand.empty': 'カタログを整理するには、まずブランドを作成してください。', 'catalog.products.empty': 'このセクションにはまだ製品がありません。', 'catalog.loadMoreBrands': 'ブランドをさらに表示', 'catalog.loadingBrands': '読み込み中…', 'catalog.loadingProducts': '製品を読み込み中…', 'catalog.previous': '前へ', 'catalog.next': '次へ', 'catalog.pageIndicator': 'ページ', 'catalog.uncategorized': '未分類', 'catalog.error': 'カタログを読み込めませんでした。', 'catalog.retry': '再試行', 'catalog.brand.imageAlt': 'ブランドロゴ', 'catalog.brand.productCatalog': '製品カタログ', 'catalog.spec.origin': '原産地', 'catalog.spec.netWeight': '内容量', 'catalog.spec.expiration': '賞味期限', 'catalog.spec.packing': '荷姿', 'product.spec.origin': '原産地', 'product.spec.netWeight': '内容量', 'product.spec.expiration': '賞味期限', 'product.spec.packing': '荷姿',
      'brand.title': 'ブランド',
    ...
    jpTitle: {
      ...
      'catalog.title': '产品目录', 'catalog.lead': '按品牌浏览产品目录。每个区块整理产品基本信息，方便快速比较。', 'catalog.back': '返回目录', 'catalog.brand.empty': '请先创建品牌以整理您的目录。', 'catalog.products.empty': '此区块暂无产品。', 'catalog.loadMoreBrands': '载入更多品牌', 'catalog.loadingBrands': '加载中…', 'catalog.loadingProducts': '正在加载产品…', 'catalog.previous': '上一页', 'catalog.next': '下一页', 'catalog.pageIndicator': '页', 'catalog.uncategorized': '未分类', 'catalog.error': '暂时无法加载产品目录。', 'catalog.retry': '重试', 'catalog.brand.imageAlt': '品牌标志', 'catalog.brand.productCatalog': '产品目录', 'catalog.spec.origin': '原产地', 'catalog.spec.netWeight': '净含量', 'catalog.spec.expiration': '保质期', 'catalog.spec.packing': '包装', 'product.spec.origin': '原产地', 'product.spec.netWeight': '净含量', 'product.spec.expiration': '保质期', 'product.spec.packing': '包装',
      'brand.title': '我们的客户',
  ...
  const animateCounter = (el) => {
    ...
    const fmt = (v) => isFloat ? v.toFixed(1) : Math.round(v).toLocaleString('en-US');
    // Reduced motion: show the final figure immediately (no counting animation).
